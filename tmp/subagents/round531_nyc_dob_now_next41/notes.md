# Round531 NYC DOB NOW Next41 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-14 through 2026-05-08.
...
Strict requested audit checked 112 prior DOB administrative candidate files plus the manual corpus through Round524. Round524 pack checked: true.
Identifier tokens checked: 314385; source URL/record tokens checked: 168002; source/date keys checked: 135241; title/date/site keys checked: 105092.
...
- Permit rows after duplicate/geography filters: 133495
- Application rows fetched: 107996
- Candidate pool before balancing: 3411
- Candidates retained: 200
- Validation report: tmp/subagents/round531_nyc_dob_now_next41/validation_report.json
