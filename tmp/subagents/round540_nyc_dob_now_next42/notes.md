# Round540 NYC DOB NOW Next42 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-09 through 2026-05-11.
...
Strict requested audit checked 113 prior DOB administrative candidate files plus the manual corpus through Round531. Round531 pack checked: true.
Identifier tokens checked: 319539; source URL/record tokens checked: 171029; source/date keys checked: 137368; title/date/site keys checked: 106619.
...
- Permit rows after duplicate/geography filters: 133295
- Application rows fetched: 107996
- Candidate pool before balancing: 3211
- Candidates retained: 200
- Validation report: tmp/subagents/round540_nyc_dob_now_next42/validation_report.json
