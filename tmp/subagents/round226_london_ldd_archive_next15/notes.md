# Round 226 London LDD archive next15 candidates
...
- Candidate output: `tmp/subagents/round226_london_ldd_archive_next15/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 2803
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 8648,
  ...
  "existing corpus or previous LDD candidate title/date": 165,
  "duplicate inside round226 batch scan": 16,
