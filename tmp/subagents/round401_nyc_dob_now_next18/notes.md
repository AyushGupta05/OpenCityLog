# Round401 NYC DOB NOW Next18 Candidate Pack
...
Screened against 370 manual-corpus/tmp candidate files and 258805 exact identifier tokens, including DOB NOW through round397, DOB CO packs available under tmp/subagents, and prior DOB permit/application packs when present.

## Counts

- Permit rows fetched: 191860
- Permit rows after duplicate/geography filters: 138100
- Application rows fetched: 107996
- Candidate pool before balancing: 8011
- Candidates retained: 200
- Validation report: tmp/subagents/round401_nyc_dob_now_next18/validation_report.json
