# Round413 NYC DOB NOW Next20 Candidate Pack
...
Screened against 384 manual-corpus/tmp candidate files and 269881 exact identifier tokens, including DOB NOW through round407, DOB CO packs available under tmp/subagents, and prior DOB permit/application packs when present.

## Counts

- Permit rows fetched: 191860
- Permit rows after duplicate/geography filters: 137699
- Application rows fetched: 107996
- Candidate pool before balancing: 7611
- Candidates retained: 200
- Validation report: tmp/subagents/round413_nyc_dob_now_next20/validation_report.json
