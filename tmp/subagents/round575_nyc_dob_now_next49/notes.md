# Round575 NYC DOB NOW Next49 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-29 through 2026-05-18.
...
Strict requested audit checked 129 prior DOB administrative candidate files plus the manual corpus through Round571. Round571 pack checked: true.
Identifier tokens checked: 343893; source URL/record tokens checked: 184406; source/date keys checked: 148345; title/date/site keys checked: 115193.
...
- Permit rows after duplicate/geography filters: 131892
- Application rows fetched: 107996
- Candidate pool before balancing: 1811
- Candidates retained: 200
- Validation report: tmp/subagents/round575_nyc_dob_now_next49/validation_report.json
