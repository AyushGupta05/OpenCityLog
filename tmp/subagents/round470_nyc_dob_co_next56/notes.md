# Round470 NYC DOB CO Next56 Candidate Pack

Generated 76 certificate-of-occupancy candidates on 2026-05-20.
...
- Unique DOB job numbers retained: 76.
- Legacy rows fetched: 142076
- Legacy grouped rows: 52945
- Duplicate/reject samples recorded: 52869
- Skipped as prior DOB/CO identifier duplicates: 9589
...
Screened 65 files, 287205 identifier tokens, 159204 source-date keys, and 73458 title/date keys, including the live manual corpus and prior DOB/CO candidate packs through round468.
...
- Unique event IDs: 76.
- Unique source/date keys: 76.
- Date window valid: true (2008-01-01 through 2026-05-20).
- NYC coordinate bounds valid: true.
- No exact event/source/date/source-URL/identifier overlap with the screened corpus and prior CO packs through round468: true.
- Status mix: bs8b-p36w|Issued=76.
