# Round 194 London LDD archive next10 candidates
...
- Candidate output: `tmp/subagents/round194_london_ldd_archive_next10/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 4003
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 7448,
  ...
  "existing corpus or previous LDD candidate title/date": 141,
  "duplicate inside round194 batch scan": 38,
