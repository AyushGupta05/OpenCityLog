# Round556 NYC DOB NOW Next45 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-29 through 2026-05-11.
...
Strict requested audit checked 121 prior DOB administrative candidate files plus the manual corpus through Round549. Round549 pack checked: true.
Identifier tokens checked: 329403; source URL/record tokens checked: 176386; source/date keys checked: 141875; title/date/site keys checked: 110323.
...
- Permit rows after duplicate/geography filters: 132694
- Application rows fetched: 107996
- Candidate pool before balancing: 2611
- Candidates retained: 200
- Validation report: tmp/subagents/round556_nyc_dob_now_next45/validation_report.json
