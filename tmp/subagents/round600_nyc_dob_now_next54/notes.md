# Round600 NYC DOB NOW Next54 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-05-19 through 2026-05-20.
...
Strict requested audit checked 141 prior DOB administrative candidate files plus the manual corpus through Round596. Round596 pack checked: true.
Identifier tokens checked: 362433; source URL/record tokens checked: 194726; source/date keys checked: 156565; title/date/site keys checked: 121613.
...
- Permit rows after duplicate/geography filters: 131096
- Application rows fetched: 108238
- Candidate pool before balancing: 835
- Candidates retained: 200
- Validation report: tmp/subagents/round600_nyc_dob_now_next54/validation_report.json
