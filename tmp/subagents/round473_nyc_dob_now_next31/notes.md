...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-29 through 2026-05-14.
...
Strict requested audit checked 91 prior DOB administrative candidate files plus the manual corpus through Round465. Round465 pack checked: true.
Identifier tokens checked: 274811; source URL/record tokens checked: 146041; source/date keys checked: 117904; title/date/site keys checked: 92157.
...
- Permit rows after duplicate/geography filters: 135497
- Application rows fetched: 107996
- Candidate pool before balancing: 5411
- Candidates retained: 200
- Validation report: tmp/subagents/round473_nyc_dob_now_next31/validation_report.json
