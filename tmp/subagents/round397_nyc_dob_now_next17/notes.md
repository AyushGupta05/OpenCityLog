# Round397 NYC DOB NOW Next17 Candidate Pack
...
Screened against 368 manual-corpus/tmp candidate files and 256986 exact identifier tokens, including DOB NOW through round293, DOB CO packs available under tmp/subagents, and prior DOB permit/application packs when present.

## Counts

- Permit rows fetched: 191860
- Permit rows after duplicate/geography filters: 138300
- Application rows fetched: 107996
- Candidate pool before balancing: 8211
- Candidates retained: 200
- Validation report: tmp/subagents/round397_nyc_dob_now_next17/validation_report.json
