# Round515 NYC DOB NOW Next38 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-15 through 2026-05-13.
...
Strict requested audit checked 106 prior DOB administrative candidate files plus the manual corpus through Round510. Round510 pack checked: true.
Identifier tokens checked: 302283; source URL/record tokens checked: 161151; source/date keys checked: 129990; title/date/site keys checked: 101041.
...
- Permit rows after duplicate/geography filters: 134095
- Application rows fetched: 107996
- Candidate pool before balancing: 4011
- Candidates retained: 200
- Validation report: tmp/subagents/round515_nyc_dob_now_next38/validation_report.json
