# Round475 NYC DOB CO Next57 Candidate Pack

Generated 0 certificate-of-occupancy candidates on 2026-05-20.

## Scope

- Official NYC Open Data legacy DOB Certificate Of Occupancy (`bs8b-p36w`) rows.
- Accessed/retrieved date: 2026-05-20.
...
- Unique DOB job numbers retained: 0.
- Legacy rows fetched: 142076
- Legacy grouped rows: 52945
- Duplicate/reject samples recorded: 52945
- Skipped as prior DOB/CO identifier duplicates: 9665
- Skipped as prior title/date duplicates: 36
...
Screened 66 files, 290006 identifier tokens, 160550 source-date keys, and 74093 title/date keys, including the live manual corpus and prior DOB/CO candidate packs through round470.
...
- Unique event IDs: 0.
- Unique source/date keys: 0.
- Date window valid: true (2008-01-01 through 2026-05-20).
- NYC coordinate bounds valid: true.
- No exact event/source/date/source-URL/identifier overlap with the screened corpus and prior CO packs through round470: true.
- Status mix: .

## Round475 Exhaustion Evidence

- Round470 was treated as the latest DOB CO dedupe boundary.
- Candidate pool before final selection after Round470 screening: 0.
- Legacy rows fetched: 142076.
- Legacy grouped rows: 52945.
- Rejected as prior DOB/CO identifier duplicates: 9665.
- No weak DOB CO rows were forced into the candidate pack.
- Duplicate audit artifact: tmp/subagents/round475_nyc_dob_co_next57/duplicate_audit.json.
