# Round407 NYC DOB NOW Next19 Candidate Pack
...
Screened against 376 manual-corpus/tmp candidate files and 263148 exact identifier tokens, including DOB NOW through round401, DOB CO packs available under tmp/subagents, and prior DOB permit/application packs when present.

## Counts

- Permit rows fetched: 191860
- Permit rows after duplicate/geography filters: 137900
- Application rows fetched: 107996
- Candidate pool before balancing: 7811
- Candidates retained: 200
- Validation report: tmp/subagents/round407_nyc_dob_now_next19/validation_report.json
