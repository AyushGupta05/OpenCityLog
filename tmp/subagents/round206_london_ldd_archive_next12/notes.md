# Round 206 London LDD archive next12 candidates
...
- Candidate output: `tmp/subagents/round206_london_ldd_archive_next12/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 3523
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 7928,
  ...
  "existing corpus or previous LDD candidate title/date": 146,
  "duplicate inside round206 batch scan": 33,
