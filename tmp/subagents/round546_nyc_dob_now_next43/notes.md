# Round546 NYC DOB NOW Next43 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-08-10 through 2026-05-12.
...
Strict requested audit checked 117 prior DOB administrative candidate files plus the manual corpus through Round540. Round540 pack checked: true.
Identifier tokens checked: 323045; source URL/record tokens checked: 172957; source/date keys checked: 138946; title/date/site keys checked: 108196.
...
- Permit rows after duplicate/geography filters: 133095
- Application rows fetched: 107996
- Candidate pool before balancing: 3011
- Candidates retained: 200
- Validation report: tmp/subagents/round546_nyc_dob_now_next43/validation_report.json
