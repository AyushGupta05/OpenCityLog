# Round520 NYC DOB NOW Next39 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-07-08 through 2026-05-13.
...
Strict requested audit checked 108 prior DOB administrative candidate files plus the manual corpus through Round515. Round515 pack checked: true.
Identifier tokens checked: 305783; source URL/record tokens checked: 163076; source/date keys checked: 131565; title/date/site keys checked: 102216.
...
- Permit rows after duplicate/geography filters: 133895
- Application rows fetched: 107996
- Candidate pool before balancing: 3811
- Candidates retained: 200
- Validation report: tmp/subagents/round520_nyc_dob_now_next39/validation_report.json
