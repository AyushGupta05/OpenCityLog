# Round604 NYC DOB NOW Next58 Candidate Pack

Generated 35 residual, nonduplicate administrative DOB NOW approved-permit candidates on 2026-05-20.
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2022-01-27 through 2026-05-15.
...
Strict requested audit checked 145 prior DOB administrative candidate files plus the manual corpus through Round603. Round603 pack checked: true.
Identifier tokens checked: 369633; source URL/record tokens checked: 197926; source/date keys checked: 160565; title/date/site keys checked: 122413.
...
- Permit rows after duplicate/geography filters: 130296
- Application rows fetched: 108238
- Candidate pool before balancing: 35
- Candidates retained: 35
- Validation report: tmp/subagents/round604_nyc_dob_now_next58/validation_report.json
