# Round493 NYC DOB NOW Next34 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-23 through 2026-05-15.
...
Strict requested audit checked 98 prior DOB administrative candidate files plus the manual corpus through Round484. Round484 pack checked: true.
Identifier tokens checked: 286695; source URL/record tokens checked: 152382; source/date keys checked: 123171; title/date/site keys checked: 95823.
...
- Permit rows after duplicate/geography filters: 134896
- Application rows fetched: 107996
- Candidate pool before balancing: 4811
- Candidates retained: 200
- Validation report: tmp/subagents/round493_nyc_dob_now_next34/validation_report.json
