# Round524 NYC DOB NOW Next40 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-01 through 2026-05-18.
...
Strict requested audit checked 110 prior DOB administrative candidate files plus the manual corpus through Round520. Round520 pack checked: true.
Identifier tokens checked: 309233; source URL/record tokens checked: 164976; source/date keys checked: 133115; title/date/site keys checked: 103366.
...
- Permit rows after duplicate/geography filters: 133695
- Application rows fetched: 107996
- Candidate pool before balancing: 3611
- Candidates retained: 200
- Validation report: tmp/subagents/round524_nyc_dob_now_next40/validation_report.json
