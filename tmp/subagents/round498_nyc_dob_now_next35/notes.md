# Round498 NYC DOB NOW Next35 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-05-31 through 2026-05-15.
...
Strict requested audit checked 99 prior DOB administrative candidate files plus the manual corpus through Round493. Round493 pack checked: true.
Identifier tokens checked: 290789; source URL/record tokens checked: 154704; source/date keys checked: 124943; title/date/site keys checked: 96995.
...
- Permit rows after duplicate/geography filters: 134696
- Application rows fetched: 107996
- Candidate pool before balancing: 4611
- Candidates retained: 200
- Validation report: tmp/subagents/round498_nyc_dob_now_next35/validation_report.json
