# Round596 NYC DOB NOW Next53 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-07-06 through 2026-05-15.
...
Strict requested audit checked 138 prior DOB administrative candidate files plus the manual corpus through Round591. Round591 pack checked: true.
Identifier tokens checked: 357073; source URL/record tokens checked: 191696; source/date keys checked: 154435; title/date/site keys checked: 119683.
...
- Permit rows after duplicate/geography filters: 131091
- Application rows fetched: 107996
- Candidate pool before balancing: 1011
- Candidates retained: 200
- Validation report: tmp/subagents/round596_nyc_dob_now_next53/validation_report.json
