# Round 182 London LDD archive next8 candidates
...
- Candidate output: `tmp/subagents/round182_london_ldd_archive_next8/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 4483
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 6968,
  ...
  "existing corpus or previous LDD candidate title/date": 127,
  "duplicate inside round182 batch scan": 52,
