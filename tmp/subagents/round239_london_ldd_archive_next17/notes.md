...
- Candidate output: `tmp/subagents/round239_london_ldd_archive_next17/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 2323
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 9128,
  ...
  "duplicate inside round239 batch scan": 10,
