# Round510 NYC DOB NOW Next37 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-11 through 2026-04-29.
...
Strict requested audit checked 104 prior DOB administrative candidate files plus the manual corpus through Round507. Round507 pack checked: true.
Identifier tokens checked: 298833; source URL/record tokens checked: 159251; source/date keys checked: 128440; title/date/site keys checked: 99891.
...
- Permit rows after duplicate/geography filters: 134295
- Application rows fetched: 107996
- Candidate pool before balancing: 4211
- Candidates retained: 200
- Validation report: tmp/subagents/round510_nyc_dob_now_next37/validation_report.json
