# Round507 NYC DOB NOW Next36 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-17 through 2026-05-14.
...
Strict requested audit checked 101 prior DOB administrative candidate files plus the manual corpus through Round498. Round498 pack checked: true.
Identifier tokens checked: 294285; source URL/record tokens checked: 156627; source/date keys checked: 126516; title/date/site keys checked: 98167.
...
- Permit rows after duplicate/geography filters: 134496
- Application rows fetched: 107996
- Candidate pool before balancing: 4411
- Candidates retained: 200
- Validation report: tmp/subagents/round507_nyc_dob_now_next36/validation_report.json
