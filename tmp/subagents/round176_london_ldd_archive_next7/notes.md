# Round 176 London LDD archive next7 candidates
...
- Candidate output: `tmp/subagents/round176_london_ldd_archive_next7/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 4723
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 6728,
  ...
  "existing corpus or previous LDD candidate title/date": 119,
  "duplicate inside round176 batch scan": 60,
