# Round 212 London LDD archive next13 candidates
...
- Candidate output: `tmp/subagents/round212_london_ldd_archive_next13/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 3283
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 8168,
  ...
  "existing corpus or previous LDD candidate title/date": 150,
  "duplicate inside round212 batch scan": 29,
