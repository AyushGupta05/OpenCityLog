# Round585 NYC DOB NOW Next51 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-04-08 through 2026-05-08.
...
Strict requested audit checked 134 prior DOB administrative candidate files plus the manual corpus through Round581. Round581 pack checked: true.
Identifier tokens checked: 351513; source URL/record tokens checked: 188666; source/date keys checked: 151705; title/date/site keys checked: 117953.
...
- Permit rows after duplicate/geography filters: 131491
- Application rows fetched: 107996
- Candidate pool before balancing: 1411
- Candidates retained: 200
- Validation report: tmp/subagents/round585_nyc_dob_now_next51/validation_report.json
