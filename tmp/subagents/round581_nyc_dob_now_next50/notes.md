# Round581 NYC DOB NOW Next50 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-02 through 2026-04-30.
...
Strict requested audit checked 132 prior DOB administrative candidate files plus the manual corpus through Round575. Round575 pack checked: true.
Identifier tokens checked: 347403; source URL/record tokens checked: 186336; source/date keys checked: 149925; title/date/site keys checked: 116573.
...
- Permit rows after duplicate/geography filters: 131691
- Application rows fetched: 107996
- Candidate pool before balancing: 1611
- Candidates retained: 200
- Validation report: tmp/subagents/round581_nyc_dob_now_next50/validation_report.json
