# Round591 NYC DOB NOW Next52 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-07-13 through 2026-05-15.
...
Strict requested audit checked 136 prior DOB administrative candidate files plus the manual corpus through Round585. Round585 pack checked: true.
Identifier tokens checked: 355473; source URL/record tokens checked: 190896; source/date keys checked: 153435; title/date/site keys checked: 119283.
...
- Permit rows after duplicate/geography filters: 131291
- Application rows fetched: 107996
- Candidate pool before balancing: 1211
- Candidates retained: 200
- Validation report: tmp/subagents/round591_nyc_dob_now_next52/validation_report.json
