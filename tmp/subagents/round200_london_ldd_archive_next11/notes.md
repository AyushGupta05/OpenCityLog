# Round 200 London LDD archive next11 candidates
...
- Candidate output: `tmp/subagents/round200_london_ldd_archive_next11/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 3763
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 7688,
  ...
  "duplicate inside round200 batch scan": 33,
