# round599_belfast_official_architecture_sweep_next38
...
- Point-backed candidates: 0
- Geometry-ref-only accepted candidates: 0
- Date range: null to null
- Dedupe boundary: Round592
- Eligible non-duplicate DfI rows before target cap: 0

## Accepted Source Mix

- Department for Infrastructure planning statistics 2024/25: 0 selected Belfast planning, listed-building, demolition-consent or statutory-consent rows with official Easting/Northing and no APP_ID/source-record overlap with the manual architecture corpus or official Belfast architecture sweep candidate/rejected/readback packs through Round592.
