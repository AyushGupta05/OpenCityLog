# Round 233 London LDD archive next16 candidates
...
- Candidate output: `tmp/subagents/round233_london_ldd_archive_next16/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 2563
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 8888,
  ...
  "existing corpus or previous LDD candidate title/date": 167,
  "duplicate inside round233 batch scan": 14,
