# Round615 NYC DOB NOW Next59 Candidate Pack

Generated 0 residual, nonduplicate administrative DOB NOW approved-permit candidates on 2026-05-20.
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: n/a through n/a.
...
Strict requested audit checked 146 prior DOB administrative candidate files plus the manual corpus through Round604. Round604 pack checked: true.
Identifier tokens checked: 375948; source URL/record tokens checked: 201066; source/date keys checked: 162240; title/date/site keys checked: 122448.
...
- Permit rows after duplicate/geography filters: 130261
- Application rows fetched: 108238
- Candidate pool before balancing: 0
- Candidates retained: 0
- Validation report: tmp/subagents/round615_nyc_dob_now_next59/validation_report.json
