# Round 301 London PLD lifecycle next28 candidates

Generated 150 candidates from official Planning London Datahub application rows accessed on 2026-05-20.

This round uses only `actual_commencement_date` and `actual_completion_date` values from `2008-01-01` through `2026-05-20`. It does not use approval-only rows, previous-permission lifecycle fields, forecast dates, or inferred delivery dates.

Deduplication scanned the live manual architecture corpus plus all discovered prior London PLD lifecycle scratch packs through round298, explicitly including round126 direct, round126 more, round140, round147, round150, round153, round157, round161, round166, round172, round178, round184, round190, round196, round202, round208, round217, round223, round230, round238, round243, round248, round253, round261, round266, round272, round276, round284, round288, and round298 by PLD row id, source URL/source record/date-field/date, source date field/date, and title/date.
