# Round571 NYC DOB NOW Next48 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-06-01 through 2026-05-07.
...
Strict requested audit checked 127 prior DOB administrative candidate files plus the manual corpus through Round566. Round566 pack checked: true.
Identifier tokens checked: 340383; source URL/record tokens checked: 182476; source/date keys checked: 146765; title/date/site keys checked: 114013.
...
- Permit rows after duplicate/geography filters: 132093
- Application rows fetched: 107996
- Candidate pool before balancing: 2011
- Candidates retained: 200
- Validation report: tmp/subagents/round571_nyc_dob_now_next48/validation_report.json
