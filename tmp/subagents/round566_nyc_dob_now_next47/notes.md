# Round566 NYC DOB NOW Next47 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-05-02 through 2026-05-14.
...
Strict requested audit checked 125 prior DOB administrative candidate files plus the manual corpus through Round561. Round561 pack checked: true.
Identifier tokens checked: 337473; source URL/record tokens checked: 180946; source/date keys checked: 145385; title/date/site keys checked: 113033.
...
- Permit rows after duplicate/geography filters: 132293
- Application rows fetched: 107996
- Candidate pool before balancing: 2211
- Candidates retained: 200
- Validation report: tmp/subagents/round566_nyc_dob_now_next47/validation_report.json
