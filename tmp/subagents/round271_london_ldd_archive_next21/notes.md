...
- Candidate output: `tmp/subagents/round271_london_ldd_archive_next21/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-20
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 1363
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 10088,
  ...
  "duplicate inside round271 batch scan": 4,
