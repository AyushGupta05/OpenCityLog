# Round561 NYC DOB NOW Next46 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-05-27 through 2026-04-23.
...
Strict requested audit checked 123 prior DOB administrative candidate files plus the manual corpus through Round556. Round556 pack checked: true.
Identifier tokens checked: 332913; source URL/record tokens checked: 178316; source/date keys checked: 143455; title/date/site keys checked: 111503.
...
- Permit rows after duplicate/geography filters: 132493
- Application rows fetched: 107996
- Candidate pool before balancing: 2411
- Candidates retained: 200
- Validation report: tmp/subagents/round561_nyc_dob_now_next46/validation_report.json
