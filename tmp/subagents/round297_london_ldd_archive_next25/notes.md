# Round 297 London LDD archive next25 candidates
...
- Candidate output: `tmp/subagents/round297_london_ldd_archive_next25/candidates.json`
- Candidate count: 162
- Cap: 240
...
- Eligible rows after dedupe and signal filters: 162
- Validation JSON: `tmp/subagents/round297_london_ldd_archive_next25/validation.json`
- Validation report: `tmp/subagents/round297_london_ldd_archive_next25/validation_report.md`
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 11288,
