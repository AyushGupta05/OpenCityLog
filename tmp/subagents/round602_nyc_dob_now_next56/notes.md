# Round602 NYC DOB NOW Next56 Candidate Pack
...
Official NYC Open Data DOB NOW Build approved permit rows (`rbx6-tga4`) joined to DOB NOW Build job application filing rows (`w9ak-ipjd`). Candidate dates are permit `issued_date` values. Requested window: 2008-01-01 through 2026-05-20. Retained candidate date range: 2021-07-20 through 2026-05-18.
...
Strict requested audit checked 143 prior DOB administrative candidate files plus the manual corpus through Round601. Round601 pack checked: true.
Identifier tokens checked: 366033; source URL/record tokens checked: 196326; source/date keys checked: 158565; title/date/site keys checked: 122013.
...
- Permit rows after duplicate/geography filters: 130696
- Application rows fetched: 108238
- Candidate pool before balancing: 435
- Candidates retained: 200
- Validation report: tmp/subagents/round602_nyc_dob_now_next56/validation_report.json
