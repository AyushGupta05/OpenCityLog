# Round 188 London LDD archive next9 candidates
...
- Candidate output: `tmp/subagents/round188_london_ldd_archive_next9/candidates.json`
- Candidate count: 240
- Cap: 240
- Accessed/retrieved date retained in outputs: 2026-05-19
- Input LDD planning-permissions rows scanned: 94948
- Eligible rows after dedupe and signal filters: 4243
...
```json
{
  ...
  "existing corpus or previous LDD candidate workbook row": 7208,
  ...
  "existing corpus or previous LDD candidate title/date": 132,
  "duplicate inside round188 batch scan": 47,
