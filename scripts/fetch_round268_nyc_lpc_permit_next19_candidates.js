...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 268;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round268_nyc_lpc_permit_next19")
  .replace(/round204/g, "round268")
  .replace(/Round204/g, "Round268")
  .replace(/next9/g, "next19")
  .replace(/Next9/g, "Next19")
  .replace(/through round198/g, "through round262");
