...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 418;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round418_nyc_lpc_permit_next50")
  .replace(/round405/g, "round418")
  .replace(/Round405/g, "Round418")
  .replace(/next48/g, "next50")
  .replace(/Next48/g, "Next50")
  .replace(/through round399/g, "through round411");
