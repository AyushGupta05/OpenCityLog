...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 518;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round518_nyc_lpc_permit_next78")
  .replace(/round505/g, "round518")
  .replace(/Round505/g, "Round518")
  .replace(/next76/g, "next78")
  .replace(/Next76/g, "Next78")
  .replace(/through round501/g, "through round513");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round513_nyc_lpc_permit_next77/candidates.json"'
);
