...
source = source
  .replace(/const ROUND = 307;/g, "const ROUND = 321;")
  .replace(/round307_nyc_lpc_permit_next25/g, "round321_nyc_lpc_permit_next28")
  .replace(/round307/g, "round321")
  .replace(/Round307/g, "Round321")
  .replace(/next25/g, "next28")
  .replace(/Next25/g, "Next28")
  .replace(/through round302/g, "through round317");
