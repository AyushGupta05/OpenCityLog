...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 363;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round363_nyc_lpc_permit_next38")
  .replace(/round351/g, "round363")
  .replace(/Round351/g, "Round363")
  .replace(/next35/g, "next38")
  .replace(/Next35/g, "Next38")
  .replace(/through round346/g, "through round359");
