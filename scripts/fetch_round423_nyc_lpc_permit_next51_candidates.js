...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 423;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round423_nyc_lpc_permit_next51")
  .replace(/round405/g, "round423")
  .replace(/Round405/g, "Round423")
  .replace(/next48/g, "next51")
  .replace(/Next48/g, "Next51")
  .replace(/through round399/g, "through round418");
