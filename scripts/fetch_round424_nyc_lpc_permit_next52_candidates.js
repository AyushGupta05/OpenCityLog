...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 424;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round424_nyc_lpc_permit_next52")
  .replace(/round405/g, "round424")
  .replace(/Round405/g, "Round424")
  .replace(/next48/g, "next52")
  .replace(/Next48/g, "Next52")
  .replace(/through round399/g, "through round423");
