...
const ROUND_ID = "round582_belfast_official_architecture_sweep_next35";
const OUT_DIR = path.join("tmp", "subagents", ROUND_ID);
const SCRIPT_PATH =
  "scripts/fetch_round582_belfast_official_architecture_sweep_next35_candidates.js";
...
const DEDUPE_BOUNDARY_ROUND = 577;
...
const METHOD = [
  "Round582 official Belfast architecture sweep next35 after the completed Round577 next34 pack.",
  ...
  "Round577 is treated as the latest Belfast official architecture sweep dedupe boundary; official page-only, geometry-ref-only, aggregate, duplicate-project, status-only, signage-only, equipment-only, condition-only and lower-priority private-use leads are retained separately."
].join(" ");

const TRANSFORMATION_METHOD = `${SCRIPT_PATH}#round582OfficialArchitectureSweepNext35`;

const SOURCES = {
  dfiPlanningStats: {
    source_id: "dfi-planning-statistics-2024-25-round582",
...
const SEARCH_QUERIES_CHECKED = [
  "local DfI planning-statistics 2024-25 Belfast residual APP_ID scan after Round577 accepted-pack dedupe",
  "local duplicate scan: data/manual_drops/architecture_milestones plus official Belfast architecture sweep candidate/rejected/readback packs through Round577",
...
function replaceRound582LeadBlocks() {
  const lead = (
    app_id,
    related_app_ids,
    event_id,
  ...
  const selectedLeads = [
    { app_id: "LA04/2024/2104/DCA" },
    { app_id: "LA04/2023/2778/O" },
    { app_id: "LA04/2025/0159/F" },
    { app_id: "LA04/2025/0180/F" },
    { app_id: "LA04/2025/0016/F" },
    { app_id: "LA04/2024/1966/F" },
    { app_id: "LA04/2024/2035/F" },
    { app_id: "LA04/2024/1632/F" },
    { app_id: "LA04/2024/1895/F" },
    { app_id: "LA04/2024/2074/F" },
    { app_id: "LA04/2025/0071/F" },
    { app_id: "LA04/2024/1874/F" },
    { app_id: "LA04/2023/4128/O" },
    { app_id: "LA04/2024/1864/F" },
    { app_id: "LA04/2024/1875/F" },
    { app_id: "LA04/2024/1902/F" },
    { app_id: "LA04/2024/1912/F" },
    { app_id: "LA04/2024/2055/F" },
    { app_id: "LA04/2025/0024/F" },
    { app_id: "LA04/2024/1834/F" },
    { app_id: "LA04/2024/1839/F" },
    { app_id: "LA04/2024/1850/F" },
    { app_id: "LA04/2024/1778/F" },
    { app_id: "LA04/2024/1860/F" },
    { app_id: "LA04/2023/4135/F" },
    { app_id: "LA04/2025/0010/F" },
    { app_id: "LA04/2024/1845/F" },
    { app_id: "LA04/2024/2159/F" },
    { app_id: "LA04/2025/0028/F" },
    { app_id: "LA04/2024/1950/F" }
  ];
  ...
  PLANNING_LEADS.splice(
    ...
    ...selectedLeads.map((selected) => {
      ...
      if (!row) throw new Error(`Selected Round582 app ID missing source row: ${selected.app_id}`);
      ...
      const eventId = `bfs_arch_round582_${slug(site)}_${appKey}_approval_${decisionYear}`;
...
replaceRound582LeadBlocks();

REJECTED_LEADS.splice(
  0,
  REJECTED_LEADS.length,
  {
    id: "bfs_arch_round582_reject_duplicate_project_rows_through_round577",
    title: "Residual duplicate-project planning rows through the Round577 boundary",
    rejection_category: "duplicate_project_boundary",
    reason:
      "Official point-backed DfI rows for already-covered project families or same-site milestones were retained outside the promoted pack because the manual architecture corpus or official Belfast architecture sweep candidate records through Round577 already cover the same project family or APP_ID.",
    source_record_id:
  ...
  {
    id: "bfs_arch_round582_reject_short_let_and_hmo_only_tail",
    ...
    source_record_id:
      "EXAMPLES:APP_ID:LA04/2023/3692/F; APP_ID:LA04/2023/2351/F; APP_ID:LA04/2024/0299/F; APP_ID:LA04/2024/0492/F; APP_ID:LA04/2024/0392/F; APP_ID:LA04/2024/0981/F; FILE:data/raw/planning_statistics/planning-statistics-2024-25-dataset.csv",
    source_url: DFI_2024_25_PUBLICATION_URL,
    source_name: SOURCES.dfiPlanningStats.source_name,
    publisher: SOURCES.dfiPlanningStats.publisher,
    source_type: SOURCES.dfiPlanningStats.source_type,
  ...
  {
    id: "bfs_arch_round582_reject_page_only_or_no_point_official_leads",
  ...
  {
    id: "bfs_arch_round582_reject_aggregate_only_dfi_quarterly_sources",
  ...
  {
    id: "bfs_arch_round582_reject_signage_equipment_condition_rows",
    ...
    source_record_id:
      "EXAMPLES:APP_ID:LA04/2025/0165/A; APP_ID:LA04/2024/1533/A; APP_ID:LA04/2024/2117/A; APP_ID:LA04/2024/1964/LBC; APP_ID:LA04/2025/0079/F; APP_ID:LA04/2024/1837/F; APP_ID:LA04/2021/0355/F; FILE:data/raw/planning_statistics/planning-statistics-2024-25-dataset.csv",
    source_url: DFI_2024_25_PUBLICATION_URL,
    source_name: SOURCES.dfiPlanningStats.source_name,
    publisher: SOURCES.dfiPlanningStats.publisher,
    source_type: SOURCES.dfiPlanningStats.source_type,
  ...
  {
    id: "bfs_arch_round582_reject_minor_domestic_tail_after_target_count",
    ...
    source_record_id:
      "EXAMPLES:APP_ID:LA04/2024/0532/F; APP_ID:LA04/2024/2088/F; APP_ID:LA04/2025/0318/DCA; FILE:data/raw/planning_statistics/planning-statistics-2024-25-dataset.csv",
    source_url: DFI_2024_25_PUBLICATION_URL,
    source_name: SOURCES.dfiPlanningStats.source_name,
    publisher: SOURCES.dfiPlanningStats.publisher,
    source_type: SOURCES.dfiPlanningStats.source_type,
    ...
    license_url: SOURCES.dfiPlanningStats.license_url,
    attribution: SOURCES.dfiPlanningStats.attribution,
    duplicate_terms: ["2 Wynchurch Terrace", "59 Marlborough Park South", "minor demolition", "single-storey rear extension"]
  }
);
...
function candidateFromPlanningLead(lead, rowsById, duplicateHaystack) {
  ...
  return {
    ...
    duplicate_review:
      `APP_ID, related APP_IDs, event_id and source_record_id were absent from the manual architecture corpus and official Belfast architecture sweep candidate/rejected/readback outputs through Round${DEDUPE_BOUNDARY_ROUND} checked by the Round582 duplicate scan.`,
...
function rejectedRecord(lead, duplicateHaystack) {
  return {
    ...
    reason: lead.reason,
    source_id: lead.id.replace(/^bfs_arch_round582_reject_/, "round582-reject-"),
...
function validate(candidates, rejected, duplicateHaystack) {
  ...
  if (candidates.length !== EXPECTED_CANDIDATE_COUNT) {
    errors.push(
      `Expected ${EXPECTED_CANDIDATE_COUNT} promoted next35 candidates, found ${candidates.length}`
    );
  }
...
function main() {
  ...
  const sourceAudit = {
    ...
    sources_checked: [
      ...
      {
        source_id: "dfi-planning-statistics-2025-26-quarterly-reviewed-round582",
        source_name: "Northern Ireland planning statistics 2025/26 provisional quarterly publications",
        publisher: "Department for Infrastructure, Northern Ireland",
        source_url: DFI_2025_26_Q3_URL,
        source_type: "official provisional quarterly planning-statistics publication",
      ...
      {
        source_id: "hed-historic-buildings-and-harni-reviewed-round582",
        ...
        accepted_records: 0,
        disposition:
          "reviewed; Historic Buildings layer lacks a usable event date for new dated listing/designation changes, while Heritage at Risk Date_Added rows are retained as status/admin leads outside this DfI residual next35 pack"
      },
      ...rejected.map((item) => ({
  ...
  const notes = [
    ...
    "- Categories are primarily residential building-fabric administrative approvals from the January-March 2025 residual tail; lower-signal short-let, signage, equipment, condition-only and aggregate leads are retained in rejected.json.",
    "",
