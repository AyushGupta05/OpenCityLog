...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 299;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round299_nyc_lpc_permit_next23")
  .replace(/round204/g, "round299")
  .replace(/Round204/g, "Round299")
  .replace(/next9/g, "next23")
  .replace(/Next9/g, "Next23")
  .replace(/through round198/g, "through round290");
