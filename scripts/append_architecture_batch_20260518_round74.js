...
const inputPaths = [
  "tmp/subagents/london_arch_candidates_round73_extra.json",
  "tmp/subagents/nyc_arch_candidates_round73_extra.json",
  "tmp/subagents/belfast_arch_candidates_round73_extra.json"
];
...
const eventFromCandidate = (candidate) => {
  ...
  return {
    ...
    geometry_precision: candidate.geocode_note && candidate.geocode_note.toLowerCase().includes("approx")
      ? "approximate point"
      : "source point",
