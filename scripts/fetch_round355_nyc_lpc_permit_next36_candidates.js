...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 355;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round355_nyc_lpc_permit_next36")
  .replace(/round351/g, "round355")
  .replace(/Round351/g, "Round355")
  .replace(/next35/g, "next36")
  .replace(/Next35/g, "Next36")
  .replace(/through round346/g, "through round351");
