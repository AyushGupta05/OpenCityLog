...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 440;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round440_nyc_lpc_permit_next57")
  .replace(/round405/g, "round440")
  .replace(/Round405/g, "Round440")
  .replace(/next48/g, "next57")
  .replace(/Next48/g, "Next57")
  .replace(/through round399/g, "through round437");
