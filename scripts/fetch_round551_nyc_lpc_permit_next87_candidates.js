...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 551;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round551_nyc_lpc_permit_next87")
  .replace(/round505/g, "round551")
  .replace(/Round505/g, "Round551")
  .replace(/next76/g, "next87")
  .replace(/Next76/g, "Next87")
  .replace(/through round501/g, "through round548");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round548_nyc_lpc_permit_next86/candidates.json"'
);
