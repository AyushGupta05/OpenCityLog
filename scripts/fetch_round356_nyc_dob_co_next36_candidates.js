...
const GENERATED_FILENAME = "scripts/fetch_round356_nyc_dob_co_next36_candidates.generated.js";
...
function transformRound308Source(source) {
  let transformed = source.replace(/\r\n/g, "\n")
    .replaceAll("round308", "round356")
    .replaceAll("Round308", "Round356")
    .replaceAll("next26", "next36")
    .replaceAll("Next26", "Next36")
    .replaceAll("through round303", "through round349");
  ...
  transformed = replaceFirst(
    ...
    `${round303File}\n];`,
    `${priorRoundFiles}\n];`,
    "explicit duplicate Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339/Round344/Round349 files"
  );
  transformed = replaceOnce(
    transformed,
    `${round303File}\n];`,
    `${priorRoundFiles}\n];`,
    "required Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339/Round344/Round349 screened files"
  );
  transformed = replaceOnce(
    transformed,
    '  "300",\n  "303"\n];',
    '  "300",\n  "303",\n  "308",\n  "313",\n  "318",\n  "322",\n  "326",\n  "330",\n  "335",\n  "339",\n  "344",\n  "349"\n];',
    "screened rounds include Round308, Round313, Round318, Round322, Round326, Round330, Round335, Round339, Round344, and Round349"
  );
  transformed = replaceOnce(
    transformed,
    ...
    "Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339/Round344/Round349 validation check fields"
  );
  transformed = replaceOnce(
    transformed,
    "  const sourceAuditEntry = {\n    ...metadata,\n    reliability:",
    "  const sourceAuditEntry = {\n    ...metadata,\n    accessed_at: ACCESSED_AT,\n    confidence: \"documented\",\n    method: \"Round356 queried the official NYC Open Data legacy DOB Certificate Of Occupancy API, filtered and grouped issued rows, screened duplicates, and retained row-level provenance.\",\n    transformation_method: \"Round356 queried the official NYC Open Data legacy DOB Certificate Of Occupancy API, filtered and grouped issued rows, screened duplicates, and retained row-level provenance.\",\n    limitations: \"Legacy CO issuance is an administrative/legal DOB record. It is not actual occupancy, public opening, completion for all spaces, construction completion, final built form, safety outcome, or affordability outcome. Coordinates are DOB/Open Data geocoded address points.\",\n    reliability:",
  ...
  transformed = replaceOnce(
    ...
    "Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339/Round344/Round349 validation report lines"
  );
  transformed = replaceOnce(
    transformed,
    "main().catch((error) => {\n  console.error(error);\n  process.exit(1);\n});",
  ...
  assertContains(transformed, "round356_nyc_dob_co_next36", "Round356 output path");
  assertContains(transformed, "Round356 NYC DOB CO Next36 Candidate Pack", "Round356 notes title");
  assertContains(transformed, "nyc_dob_co_round356_legacy_", "Round356 candidate ID prefix");
  ...
  assertContains(transformed, REQUIRED_ROUND349_FILE, "Round349 screened file");
  assertContains(transformed, '  "308",\n  "313",\n  "318",\n  "322",\n  "326",\n  "330",\n  "335",\n  "339",\n  "344",\n  "349"\n];', "screened rounds include 308, 313, 318, 322, 326, 330, 335, 339, 344, and 349");
  assertContains(transformed, "through round349", "duplicate-screening text through Round349");
  ...
  assertContains(transformed, "required_round349_screened", "Round349 validation result");
  ...
  assertContains(transformed, "transformation_method: \"Round356 queried", "source audit transformation method");
  assertContains(transformed, "scripts/fetch_round356_nyc_dob_co_next36_candidates.js standalone validation artifact", "Round356 validator label");
...
async function main() {
  ...
  if (typeof sandbox.module.exports.main !== "function") {
    throw new Error("Transformed Round356 generator did not export main().");
  }
