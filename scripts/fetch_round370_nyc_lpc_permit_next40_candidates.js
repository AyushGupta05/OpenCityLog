...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 370;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round370_nyc_lpc_permit_next40")
  .replace(/round351/g, "round370")
  .replace(/Round351/g, "Round370")
  .replace(/next35/g, "next40")
  .replace(/Next35/g, "Next40")
  .replace(/through round346/g, "through round366");
