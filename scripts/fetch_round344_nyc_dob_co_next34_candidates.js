...
const GENERATED_FILENAME = "scripts/fetch_round344_nyc_dob_co_next34_candidates.generated.js";
...
function transformRound308Source(source) {
  let transformed = source.replace(/\r\n/g, "\n")
    .replaceAll("round308", "round344")
    .replaceAll("Round308", "Round344")
    .replaceAll("next26", "next34")
    .replaceAll("Next26", "Next34")
    .replaceAll("through round303", "through round339");
  ...
  transformed = replaceFirst(
    ...
    `${round303File}\n];`,
    `${priorRoundFiles}\n];`,
    "explicit duplicate Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339 files"
  );
  transformed = replaceOnce(
    transformed,
    `${round303File}\n];`,
    `${priorRoundFiles}\n];`,
    "required Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339 screened files"
  );
  transformed = replaceOnce(
    transformed,
    '  "300",\n  "303"\n];',
    '  "300",\n  "303",\n  "308",\n  "313",\n  "318",\n  "322",\n  "326",\n  "330",\n  "335",\n  "339"\n];',
    "screened rounds include Round308, Round313, Round318, Round322, Round326, Round330, Round335, and Round339"
  );
  transformed = replaceOnce(
    transformed,
    ...
    "Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339 validation check fields"
  );
  transformed = replaceOnce(
    transformed,
    "  const sourceAuditEntry = {\n    ...metadata,\n    reliability:",
    "  const sourceAuditEntry = {\n    ...metadata,\n    accessed_at: ACCESSED_AT,\n    confidence: \"documented\",\n    method: \"Round344 queried the official NYC Open Data legacy DOB Certificate Of Occupancy API, filtered and grouped issued rows, screened duplicates, and retained row-level provenance.\",\n    transformation_method: \"Round344 queried the official NYC Open Data legacy DOB Certificate Of Occupancy API, filtered and grouped issued rows, screened duplicates, and retained row-level provenance.\",\n    limitations: \"Legacy CO issuance is an administrative/legal DOB record. It is not actual occupancy, public opening, completion for all spaces, construction completion, final built form, safety outcome, or affordability outcome. Coordinates are DOB/Open Data geocoded address points.\",\n    reliability:",
  ...
  transformed = replaceOnce(
    ...
    "Round308/Round313/Round318/Round322/Round326/Round330/Round335/Round339 validation report lines"
  );
  transformed = replaceOnce(
    transformed,
    "main().catch((error) => {\n  console.error(error);\n  process.exit(1);\n});",
  ...
  assertContains(transformed, "round344_nyc_dob_co_next34", "Round344 output path");
  assertContains(transformed, "Round344 NYC DOB CO Next34 Candidate Pack", "Round344 notes title");
  assertContains(transformed, "nyc_dob_co_round344_legacy_", "Round344 candidate ID prefix");
  ...
  assertContains(transformed, '  "308",\n  "313",\n  "318",\n  "322",\n  "326",\n  "330",\n  "335",\n  "339"\n];', "screened rounds include 308, 313, 318, 322, 326, 330, 335, and 339");
  assertContains(transformed, "through round339", "duplicate-screening text through Round339");
  ...
  assertContains(transformed, "transformation_method: \"Round344 queried", "source audit transformation method");
  assertContains(transformed, "scripts/fetch_round344_nyc_dob_co_next34_candidates.js standalone validation artifact", "Round344 validator label");
...
async function main() {
  ...
  if (typeof sandbox.module.exports.main !== "function") {
    throw new Error("Transformed Round344 generator did not export main().");
  }
