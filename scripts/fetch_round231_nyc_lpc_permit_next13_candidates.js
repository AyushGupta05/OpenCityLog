...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 231;")
  .replace(/round204_nyc_lpc_permit_next9/g, "round231_nyc_lpc_permit_next13")
  .replace(/round204/g, "round231")
  .replace(/Round204/g, "Round231")
  .replace(/next9/g, "next13")
  .replace(/Next9/g, "Next13")
  .replace(/through round198/g, "through round224");
