...
const candidateFiles = [
  "tmp/subagents/london_arch_candidates_round100.json",
  "tmp/subagents/nyc_arch_candidates_round100.json",
  "tmp/subagents/belfast_arch_candidates_round100.json"
];

const selectedIds = new Set([
  "lon_arch_royal_docks_centre_sustainability_opening_2023",
  "lon_arch_ilford_exchange_health_centre_opening_2024",
  "lon_arch_ealing_community_diagnostic_centre_opening_2024",
  "lon_arch_eltham_community_diagnostic_centre_opening_2025",
  "lon_arch_highgate_library_reopening_2024",
  "nyc_arch_morgan_library_mckim_reopening_2010",
  "nyc_arch_rockefeller_river_campus_opening_2019",
  "nyc_arch_ocean_avenue_pedestrian_bridge_rehabilitation_ribbon_cutting_2025",
  "nyc_arch_harlem_river_greenway_bailey_avenue_completion_2025",
  "bfs_arch_st_marys_cbs_sports_hall_approved_2026",
  "bfs_arch_college_gardens_listed_conversion_approved_2026",
  "bfs_arch_wishing_well_childcare_hub_operational_by_2021"
]);
...
const areaById = {
  lon_arch_royal_docks_centre_sustainability_opening_2023: "Royal Docks / University of East London",
  lon_arch_ilford_exchange_health_centre_opening_2024: "Ilford",
  lon_arch_ealing_community_diagnostic_centre_opening_2024: "Ealing",
  lon_arch_eltham_community_diagnostic_centre_opening_2025: "Eltham",
  lon_arch_highgate_library_reopening_2024: "Highgate",
  nyc_arch_morgan_library_mckim_reopening_2010: "Murray Hill",
  nyc_arch_rockefeller_river_campus_opening_2019: "Upper East Side / Rockefeller University",
  nyc_arch_ocean_avenue_pedestrian_bridge_rehabilitation_ribbon_cutting_2025: "Sheepshead Bay / Ocean Avenue",
  nyc_arch_harlem_river_greenway_bailey_avenue_completion_2025: "Kingsbridge / Bailey Avenue",
  bfs_arch_st_marys_cbs_sports_hall_approved_2026: "Glen Road / St Mary's CBS",
  bfs_arch_college_gardens_listed_conversion_approved_2026: "College Gardens",
  bfs_arch_wishing_well_childcare_hub_operational_by_2021: "North Belfast / Wishing Well Family Centre"
};
...
const observedChangeFor = (candidate) => {
  ...
  if (text.includes("reopening") || text.includes("reopened")) {
    return "A documented reopening milestone was recorded for the named facility.";
  }
  if (text.includes("ribbon") || text.includes("completion") || text.includes("completed")) {
    return "A documented completion or ribbon-cutting milestone was recorded for the named facility or public-realm project.";
  }
...
const sourceDateFieldFor = (candidate) => {
  ...
  if (text.includes("reopening") || text.includes("reopened")) return "source records the reopening date";
  if (text.includes("ribbon") || text.includes("completion") || text.includes("completed")) return "source records the completion or ribbon-cutting date";
...
const outputPath = `${path}.round100.tmp`;
