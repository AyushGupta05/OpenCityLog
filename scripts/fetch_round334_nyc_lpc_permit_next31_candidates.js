...
source = source
  .replace(/const ROUND = 329;/g, "const ROUND = 334;")
  .replace(/round329_nyc_lpc_permit_next30/g, "round334_nyc_lpc_permit_next31")
  .replace(/round329/g, "round334")
  .replace(/Round329/g, "Round334")
  .replace(/next30/g, "next31")
  .replace(/Next30/g, "Next31")
  .replace(/through round325/g, "through round329");
