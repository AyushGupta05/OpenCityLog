...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 381;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round381_nyc_lpc_permit_next43")
  .replace(/round351/g, "round381")
  .replace(/Round351/g, "Round381")
  .replace(/next35/g, "next43")
  .replace(/Next35/g, "Next43")
  .replace(/through round346/g, "through round378");
