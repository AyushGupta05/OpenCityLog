...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 447;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round447_nyc_lpc_permit_next60")
  .replace(/round405/g, "round447")
  .replace(/Round405/g, "Round447")
  .replace(/next48/g, "next60")
  .replace(/Next48/g, "Next60")
  .replace(/through round399/g, "through round446");
