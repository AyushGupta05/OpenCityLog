...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 459;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round459_nyc_lpc_permit_next63")
  .replace(/round405/g, "round459")
  .replace(/Round405/g, "Round459")
  .replace(/next48/g, "next63")
  .replace(/Next48/g, "Next63")
  .replace(/through round399/g, "through round455");
