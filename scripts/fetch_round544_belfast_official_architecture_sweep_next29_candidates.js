...
const ROUND_ID = "round544_belfast_official_architecture_sweep_next29";
const OUT_DIR = path.join("tmp", "subagents", ROUND_ID);
const SCRIPT_PATH =
  "scripts/fetch_round544_belfast_official_architecture_sweep_next29_candidates.js";
const GENERATED_AT = "2026-05-20";
const ACCESSED_AT = "2026-05-20";
const CITY_ID = "belfast";
const EXPECTED_CANDIDATE_COUNT = 29;
const DATE_WINDOW = {
  start: "2008-01-01",
  end: "2026-05-20"
};
const DEDUPE_BOUNDARY_ROUND = 538;
...
const METHOD = [
  "Round544 official Belfast architecture sweep next29 after the completed Round538 next28 pack.",
  ...
  "Round538 is treated as the latest Belfast official architecture sweep dedupe boundary; official page-only, geometry-ref-only, duplicate-project, status-only, signage-only, equipment-only and lower-priority private-use leads are retained separately."
].join(" ");

const TRANSFORMATION_METHOD = `${SCRIPT_PATH}#round544OfficialArchitectureSweepNext29`;

const SOURCES = {
  dfiPlanningStats: {
    source_id: "dfi-planning-statistics-2024-25-round544",
...
const SEARCH_QUERIES_CHECKED = [
  "local DfI planning-statistics 2024-25 Belfast residual APP_ID scan after Round538 accepted-pack dedupe",
  "local duplicate scan: data/manual_drops/architecture_milestones plus official Belfast architecture sweep candidate packs through Round538",
...
function replaceRound544LeadBlocks() {
  const lead = (
    app_id,
    related_app_ids,
    event_id,
  ...
  PLANNING_LEADS.splice(
    ...
    lead(
      "LA04/2024/0029/F",
      [],
      "bfs_arch_round544_bristow_drive_first_floor_rear_side_extension_approval_2024",
      "1 Bristow Drive first-floor rear and side extension approval was recorded",
      "Official planning-statistics row records approval for first-floor rear and side extension at 1 Bristow Drive.",
      "First-floor rear and side extension.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "first-floor rear and side residential extension approval"
    ),
    lead(
      "LA04/2023/3900/F",
      [],
      "bfs_arch_round544_gransha_gardens_side_rear_extension_approval_2024",
      "4 Gransha Gardens side/rear extension approval was recorded",
      "Official planning-statistics row records approval for single-storey side and rear extension with internal alterations at 4 Gransha Gardens.",
      "Single-storey side and rear extension with internal alterations.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "single-storey side/rear extension with internal alterations"
    ),
    lead(
      "LA04/2023/4610/F",
      [],
      "bfs_arch_round544_crumlin_road_side_rear_extension_approval_2024",
      "126 Crumlin Road side/rear extension approval was recorded",
      "Official planning-statistics row records approval for single-storey side and rear extension with associated site works at 126 Crumlin Road.",
      "Single-storey side and rear extension and associated site works.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "single-storey side/rear extension with associated site works"
    ),
    lead(
      "LA04/2024/0073/F",
      [],
      "bfs_arch_round544_ravenhill_park_rear_garage_approval_2024",
      "24 Ravenhill Park rear-garage approval was recorded",
      "Official planning-statistics row records approval for a single-storey garage to the rear of 24 Ravenhill Park.",
      "Single-storey garage to rear of dwelling.",
      "planning_decision_residential_outbuilding",
      "architecture_residential_fabric_admin",
      "rear garage approval"
    ),
    lead(
      "LA04/2024/0030/F",
      [],
      "bfs_arch_round544_orangefield_avenue_side_extension_approval_2024",
      "63 Orangefield Avenue side-extension approval was recorded",
      "Official planning-statistics row records approval for a single-storey side extension at 63 Orangefield Avenue.",
      "Single-storey extension to side of existing dwelling.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
    ...
    lead(
      "LA04/2024/0274/F",
      [],
      "bfs_arch_round544_tweskard_park_side_extension_approval_2024",
      "7 Tweskard Park side-extension approval was recorded",
      "Official planning-statistics row records approval for a single-storey side extension at 7 Tweskard Park.",
      "Single-storey side extension.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "single-storey side extension"
    ...
    lead(
      "LA04/2023/2761/F",
      [],
      "bfs_arch_round544_antrim_road_detached_dwelling_approval_2024",
      "737a Antrim Road detached-dwelling approval was recorded",
      "Official planning-statistics row records approval for construction of a detached two-storey dwelling and associated site works at 737a Antrim Road.",
      "Construction of a new detached two-storey dwelling and associated site works.",
      "planning_decision_residential_development",
      "architecture_residential_development_admin",
      "detached two-storey dwelling approval"
    ),
    lead(
      "LA04/2023/2910/F",
      [],
      "bfs_arch_round544_marlborough_park_north_sunroom_renewal_approval_2024",
      "82 Marlborough Park North sunroom-extension renewal approval was recorded",
      "Official planning-statistics row records approval for renewal of an earlier permission for a single-storey side sunroom extension at 82 Marlborough Park North.",
      "Renewal of planning permission for single-storey side sunroom extension.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "side sunroom extension renewal approval"
    ),
    lead(
      "LA04/2024/0083/F",
      [],
      "bfs_arch_round544_lismoyne_park_two_storey_rear_extension_approval_2024",
      "41 Lismoyne Park two-storey rear-extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey rear extension at 41 Lismoyne Park.",
    ...
    lead(
      "LA04/2024/0116/F",
      [],
      "bfs_arch_round544_upper_newtownards_road_rear_extension_approval_2024",
      "549 Upper Newtownards Road rear-extension approval was recorded",
      "Official planning-statistics row records approval for a rear single-storey extension at 549 Upper Newtownards Road.",
    ...
    lead(
      "LA04/2024/0091/F",
      [],
      "bfs_arch_round544_katrine_park_rear_side_extensions_approval_2024",
      "45 Katrine Park rear and side extension approval was recorded",
      "Official planning-statistics row records approval for a single-storey rear extension and two-storey side extension at 45 Katrine Park.",
      "Single-storey extension to rear of dwelling and two-storey extension to side of dwelling.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "rear single-storey and side two-storey extensions"
    ),
    lead(
      "LA04/2023/4575/F",
      [],
      "bfs_arch_round544_glenhill_park_two_storey_rear_side_extension_approval_2024",
      "19 Glenhill Park two-storey rear/side extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey rear kitchen/snug and side extension with first-floor bedroom and ensuite at 19 Glenhill Park.",
      "Two-storey rear kitchen/snug and side extension with first-floor bedroom and ensuite, including internal remodelling.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "two-storey rear/side residential extension with internal remodelling"
    ),
    lead(
      "LA04/2024/0108/F",
      [],
      "bfs_arch_round544_college_square_north_switchroom_cycle_stands_approval_2024",
      "College Square North switchroom and cycle-stands approval was recorded",
      "Official planning-statistics row records retrospective approval for erection of a ground-floor switch room and seven cycle stands on lands adjacent to 14 College Square North and south of 62-67 Hamill Street.",
      "Erection of ground-floor switch room and seven cycle stands.",
      "planning_decision_commercial_site_infrastructure",
      "architecture_commercial_development_admin",
      "ground-floor switchroom and cycle-stands approval"
    ),
    lead(
      "LA04/2024/0192/F",
      [],
      "bfs_arch_round544_piney_lane_rear_side_extension_elevational_changes_approval_2024",
      "5 Piney Lane rear/side extension and elevational-changes approval was recorded",
      "Official planning-statistics row records approval for single-storey rear and side extension, new front entrance canopy and elevational changes at 5 Piney Lane.",
      "Single-storey rear and side extension, new front entrance canopy and elevational changes.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "rear/side extension, entrance canopy and elevational changes"
    ),
    lead(
      "LA04/2024/0327/F",
      [],
      "bfs_arch_round544_tower_court_rear_extension_approval_2024",
      "14 Tower Court rear-extension approval was recorded",
      "Official planning-statistics row records approval for a single-storey rear extension at 14 Tower Court.",
    ...
    lead(
      "LA04/2024/0261/F",
      [],
      "bfs_arch_round544_castlereagh_road_two_storey_side_rear_extension_approval_2024",
      "300 Castlereagh Road two-storey side/rear extension approval was recorded",
      "Official planning-statistics row records approval for two-storey side and rear extension and incorporation of garage into utility room at 300 Castlereagh Road.",
      "Two-storey side and rear extension and incorporation of garage into utility room.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "two-storey side/rear extension and garage incorporation"
    ),
    lead(
      "LA04/2024/0378/F",
      [],
      "bfs_arch_round544_sandford_avenue_side_rear_extension_terrace_approval_2024",
      "19 Sandford Avenue side/rear extension and terrace approval was recorded",
      "Official planning-statistics row records approval for two-storey side extension, single-storey side/rear extension including demolition of rear return, and first-floor terrace at 19 Sandford Avenue.",
      "Two-storey side extension, single-storey side/rear extension including demolition of rear return, and first-floor terrace.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "side/rear extensions, rear-return demolition and first-floor terrace"
    ),
    lead(
      "LA04/2024/0292/F",
      [],
      "bfs_arch_round544_aberfoyle_front_rear_extensions_approval_2024",
      "4 Aberfoyle Park front and rear extension approval was recorded",
      "Official planning-statistics row records approval for single-storey front and rear extensions at 4 Aberfoyle Park.",
    ...
    lead(
      "LA04/2024/0194/F",
      [],
      "bfs_arch_round544_fruithill_park_two_storey_side_rear_extension_approval_2024",
      "39 Fruithill Park two-storey side/rear extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey side and rear extension, including a single-storey rear extension, at 39 Fruithill Park.",
      "Two-storey extension to side and rear of dwelling, including single-storey extension to rear.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "two-storey side/rear extension with single-storey rear element"
    ),
    lead(
      "LA04/2023/2960/F",
      [],
      "bfs_arch_round544_merok_gardens_garage_removed_rear_side_extension_approval_2024",
      "9 Merok Gardens garage-removal and rear/side extension approval was recorded",
      "Official planning-statistics row records approval to remove an existing garage and provide a single-storey rear/side extension at 9 Merok Gardens.",
      "Remove existing garage to provide single-storey rear/side extension to dwelling.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "garage removal and single-storey rear/side extension"
    ),
    lead(
      "LA04/2023/3140/F",
      [],
      "bfs_arch_round544_dunlambert_drive_two_storey_side_rear_extension_approval_2024",
      "89 Dunlambert Drive two-storey side/rear extension approval was recorded",
      "Official planning-statistics row records approval for two-storey side and rear extension at 89 Dunlambert Drive.",
    ...
    lead(
      "LA04/2023/4004/O",
      [],
      "bfs_arch_round544_upper_springfield_road_two_dwellings_outline_approval_2024",
      "Upper Springfield Road two-dwellings outline approval was recorded",
      "Official planning-statistics row records outline approval for two dwellings on land to the rear of 14 and 14a and adjacent to 151 Upper Springfield Road.",
      "Outline application for two dwellings.",
      "planning_decision_residential_outline",
      "architecture_residential_development_admin",
      "outline approval for two dwellings"
    ),
    lead(
      "LA04/2023/3711/F",
      [],
      "bfs_arch_round544_wynchurch_avenue_two_storey_extension_approval_2024",
      "28 Wynchurch Avenue two-storey extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey extension and associated alterations at 28 Wynchurch Avenue.",
      "Two-storey extension and associated alterations.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "two-storey extension and associated alterations"
    ),
    lead(
      "LA04/2023/4028/F",
      [],
      "bfs_arch_round544_glencregagh_drive_rear_extension_storage_patio_approval_2024",
      "28 Glencregagh Drive rear-extension, storage and patio approval was recorded",
      "Official planning-statistics row records approval for rear ground-floor extension, lower-ground-floor storage, raised patio, rooflights and chimney-height reduction at 28 Glencregagh Drive.",
      "Single-storey rear extension at ground floor, storage at lower-ground-floor level, raised patio, rooflights and chimney-height reduction.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "rear extension, lower-ground storage, patio and roof alterations"
    ),
    lead(
      "LA04/2024/0342/F",
      [],
      "bfs_arch_round544_willesden_park_two_storey_rear_side_extension_approval_2024",
      "1 Willesden Park two-storey rear/side extension approval was recorded",
      "Official planning-statistics row records approval for two-storey rear and side extension at 1 Willesden Park.",
    ...
    lead(
      "LA04/2024/0155/F",
      [],
      "bfs_arch_round544_knockbracken_park_side_rear_extension_approval_2024",
      "16 Knockbracken Park side/rear extension approval was recorded",
      "Official planning-statistics row records approval for a single-storey side/rear extension at 16 Knockbracken Park.",
    ...
    lead(
      "LA04/2023/4293/F",
      [],
      "bfs_arch_round544_mountainview_gardens_two_storey_rear_side_extension_approval_2024",
      "21 Mountainview Gardens two-storey rear/side extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey rear/side extension at 21 Mountainview Gardens.",
      "Two-storey extension to rear/side of dwelling.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
    ...
    lead(
      "LA04/2024/0228/F",
      [],
      "bfs_arch_round544_glengoland_gardens_two_storey_rear_extension_approval_2024",
      "30 Glengoland Gardens two-storey rear-extension approval was recorded",
      "Official planning-statistics row records approval for a rear two-storey extension with external paved space at 30 Glengoland Gardens.",
      "Rear two-storey extension with external paved space.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "rear two-storey extension with external paved space"
    ),
    lead(
      "LA04/2023/4369/F",
      [],
      "bfs_arch_round544_roddens_crescent_two_storey_rear_side_extension_approval_2024",
      "19 Roddens Crescent two-storey rear/side extension approval was recorded",
      "Official planning-statistics row records approval for a two-storey rear and side extension with rear decking at 19 Roddens Crescent.",
      "Two-storey rear and side extension to dwelling and decking to rear.",
      "planning_decision_residential_extension",
      "architecture_residential_fabric_admin",
      "two-storey rear/side extension with rear decking"
    )
  );
}

replaceRound544LeadBlocks();

REJECTED_LEADS.splice(
  0,
  REJECTED_LEADS.length,
  {
    id: "bfs_arch_round544_reject_duplicate_project_rows_through_round538",
    title: "Residual duplicate-project planning rows through the Round538 boundary",
    rejection_category: "duplicate_project_boundary",
    reason:
      "Official point-backed DfI rows for already-covered project families or same-site milestones were retained outside the promoted pack because the manual architecture corpus or official Belfast architecture sweep candidate records through Round538 already cover the same project family.",
    source_record_id:
  ...
  {
    id: "bfs_arch_round544_reject_short_let_and_hmo_only_tail",
  ...
  {
    id: "bfs_arch_round544_reject_page_only_or_no_point_official_leads",
  ...
  {
    id: "bfs_arch_round544_reject_signage_equipment_transport_rows",
...
function candidateFromPlanningLead(lead, rowsById, duplicateHaystack) {
  ...
  return {
    ...
    duplicate_review:
      `APP_ID, related APP_IDs, event_id and source_record_id were absent from the manual architecture corpus and official Belfast architecture sweep candidate outputs through Round${DEDUPE_BOUNDARY_ROUND} checked by the Round544 duplicate scan.`,
...
function rejectedRecord(lead, duplicateHaystack) {
  return {
    ...
    reason: lead.reason,
    source_id: lead.id.replace(/^bfs_arch_round544_reject_/, "round544-reject-"),
...
function validate(candidates, rejected, duplicateHaystack) {
  ...
  if (candidates.length !== EXPECTED_CANDIDATE_COUNT) {
    errors.push(
      `Expected ${EXPECTED_CANDIDATE_COUNT} promoted next29 candidates, found ${candidates.length}`
    );
  }
...
function main() {
  ...
  const sourceAudit = {
    ...
    sources_checked: [
      ...
      {
        source_id: "dfi-planning-statistics-2025-26-quarterly-reviewed-round544",
      ...
      {
        source_id: "hed-historic-buildings-and-harni-reviewed-round544",
        ...
        accepted_records: 0,
        disposition:
          "reviewed; Historic Buildings layer lacks a usable event date for new dated listing/designation changes, while Heritage at Risk Date_Added rows are retained as status/admin leads outside this DfI residual next29 pack"
      },
      ...rejected.map((item) => ({
