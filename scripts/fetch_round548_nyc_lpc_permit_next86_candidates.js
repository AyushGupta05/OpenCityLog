...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 548;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round548_nyc_lpc_permit_next86")
  .replace(/round505/g, "round548")
  .replace(/Round505/g, "Round548")
  .replace(/next76/g, "next86")
  .replace(/Next76/g, "Next86")
  .replace(/through round501/g, "through round543");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round543_nyc_lpc_permit_next85/candidates.json"'
);
