...
source = source
  .replace(/const ROUND = 342;/g, "const ROUND = 346;")
  .replace(/round342_nyc_lpc_permit_next33/g, "round346_nyc_lpc_permit_next34")
  .replace(/round342/g, "round346")
  .replace(/Round342/g, "Round346")
  .replace(/next33/g, "next34")
  .replace(/Next33/g, "Next34")
  .replace(/through round337/g, "through round342");
