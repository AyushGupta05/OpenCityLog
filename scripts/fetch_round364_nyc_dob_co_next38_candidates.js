...
const GENERATED_FILENAME = "scripts/fetch_round364_nyc_dob_co_next38_candidates.generated.js";
...
const REQUIRED_ROUND360_FILE = "tmp/subagents/round360_nyc_dob_co_next37/candidates.json";
...
function transformRound308Source(source) {
  let transformed = source.replace(/\r\n/g, "\n")
    .replaceAll("round308", "round364")
    .replaceAll("Round308", "Round364")
    .replaceAll("next26", "next38")
    .replaceAll("Next26", "Next38")
    .replaceAll("through round303", "through round360");
  ...
  assertContains(transformed, "round364_nyc_dob_co_next38", "Round364 output path");
  assertContains(transformed, "Round364 NYC DOB CO Next38 Candidate Pack", "Round364 notes title");
  assertContains(transformed, "nyc_dob_co_round364_legacy_", "Round364 candidate ID prefix");
  assertContains(transformed, REQUIRED_ROUND360_FILE, "Round360 screened file");
  assertContains(transformed, "through round360", "duplicate-screening text through Round360");
  assertContains(transformed, "required_round360_screened", "Round360 validation result");
  ...
  assertContains(transformed, "transformation_method: \"Round364 queried", "Round364 source audit transformation method");
  assertContains(transformed, "scripts/fetch_round364_nyc_dob_co_next38_candidates.js standalone validation artifact", "Round364 validator label");
...
async function main() {
  ...
  if (typeof sandbox.module.exports.main !== "function") {
    throw new Error("Transformed Round364 generator did not export main().");
  }
