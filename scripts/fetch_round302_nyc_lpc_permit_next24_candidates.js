...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 302;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round302_nyc_lpc_permit_next24")
  .replace(/round204/g, "round302")
  .replace(/Round204/g, "Round302")
  .replace(/next9/g, "next24")
  .replace(/Next9/g, "Next24")
  .replace(/through round198/g, "through round299");
