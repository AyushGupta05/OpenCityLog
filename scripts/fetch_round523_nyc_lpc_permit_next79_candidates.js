...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 523;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round523_nyc_lpc_permit_next79")
  .replace(/round505/g, "round523")
  .replace(/Round505/g, "Round523")
  .replace(/next76/g, "next79")
  .replace(/Next76/g, "Next79")
  .replace(/through round501/g, "through round518");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round518_nyc_lpc_permit_next78/candidates.json"'
);
