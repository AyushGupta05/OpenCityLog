...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 455;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round455_nyc_lpc_permit_next62")
  .replace(/round405/g, "round455")
  .replace(/Round405/g, "Round455")
  .replace(/next48/g, "next62")
  .replace(/Next48/g, "Next62")
  .replace(/through round399/g, "through round450");
