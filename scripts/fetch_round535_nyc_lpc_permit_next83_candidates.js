...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 535;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round535_nyc_lpc_permit_next83")
  .replace(/round505/g, "round535")
  .replace(/Round505/g, "Round535")
  .replace(/next76/g, "next83")
  .replace(/Next76/g, "Next83")
  .replace(/through round501/g, "through round530");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round530_nyc_lpc_permit_next82/candidates.json"'
);
