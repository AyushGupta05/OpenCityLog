...
source = source
  .replace(/const ROUND = 492;/g, "const ROUND = 497;")
  .replace(/round492_nyc_lpc_permit_next73/g, "round497_nyc_lpc_permit_next74")
  .replace(/round492/g, "round497")
  .replace(/Round492/g, "Round497")
  .replace(/next73/g, "next74")
  .replace(/Next73/g, "Next74")
  .replace(/through round491/g, "through round492");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round492_nyc_lpc_permit_next73/candidates.json"'
);
