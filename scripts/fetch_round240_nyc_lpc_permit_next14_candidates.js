...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 240;")
  .replace(/round204_nyc_lpc_permit_next9/g, "round240_nyc_lpc_permit_next14")
  .replace(/round204/g, "round240")
  .replace(/Round204/g, "Round240")
  .replace(/next9/g, "next14")
  .replace(/Next9/g, "Next14")
  .replace(/through round198/g, "through round231");
