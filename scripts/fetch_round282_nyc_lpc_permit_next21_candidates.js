...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 282;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round282_nyc_lpc_permit_next21")
  .replace(/round204/g, "round282")
  .replace(/Round204/g, "Round282")
  .replace(/next9/g, "next21")
  .replace(/Next9/g, "Next21")
  .replace(/through round198/g, "through round274");
