...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 274;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round274_nyc_lpc_permit_next20")
  .replace(/round204/g, "round274")
  .replace(/Round204/g, "Round274")
  .replace(/next9/g, "next20")
  .replace(/Next9/g, "Next20")
  .replace(/through round198/g, "through round268");
