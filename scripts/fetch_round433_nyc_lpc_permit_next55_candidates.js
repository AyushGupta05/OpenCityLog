...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 433;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round433_nyc_lpc_permit_next55")
  .replace(/round405/g, "round433")
  .replace(/Round405/g, "Round433")
  .replace(/next48/g, "next55")
  .replace(/Next48/g, "Next55")
  .replace(/through round399/g, "through round430");
