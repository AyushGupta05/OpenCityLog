...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 249;")
  .replace(/round204_nyc_lpc_permit_next9/g, "round249_nyc_lpc_permit_next16")
  .replace(/round204/g, "round249")
  .replace(/Round204/g, "Round249")
  .replace(/next9/g, "next16")
  .replace(/Next9/g, "Next16")
  .replace(/through round198/g, "through round244");
