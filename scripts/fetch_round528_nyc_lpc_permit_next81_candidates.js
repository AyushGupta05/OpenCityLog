...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 528;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round528_nyc_lpc_permit_next81")
  .replace(/round505/g, "round528")
  .replace(/Round505/g, "Round528")
  .replace(/next76/g, "next81")
  .replace(/Next76/g, "Next81")
  .replace(/through round501/g, "through round525");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round525_nyc_lpc_permit_next80/candidates.json"'
);
