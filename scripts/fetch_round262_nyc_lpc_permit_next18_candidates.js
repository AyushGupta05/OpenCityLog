...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 262;")
  .replace(/const ACCESSED_AT = "2026-05-19";/g, 'const ACCESSED_AT = "2026-05-20";')
  .replace(/round204_nyc_lpc_permit_next9/g, "round262_nyc_lpc_permit_next18")
  .replace(/round204/g, "round262")
  .replace(/Round204/g, "Round262")
  .replace(/next9/g, "next18")
  .replace(/Next9/g, "Next18")
  .replace(/through round198/g, "through round254");
