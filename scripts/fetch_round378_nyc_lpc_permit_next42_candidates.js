...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 378;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round378_nyc_lpc_permit_next42")
  .replace(/round351/g, "round378")
  .replace(/Round351/g, "Round378")
  .replace(/next35/g, "next42")
  .replace(/Next35/g, "Next42")
  .replace(/through round346/g, "through round374");
