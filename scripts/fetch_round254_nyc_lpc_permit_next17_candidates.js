...
source = source
  .replace(/const ROUND = 204;/g, "const ROUND = 254;")
  .replace(/round204_nyc_lpc_permit_next9/g, "round254_nyc_lpc_permit_next17")
  .replace(/round204/g, "round254")
  .replace(/Round204/g, "Round254")
  .replace(/next9/g, "next17")
  .replace(/Next9/g, "Next17")
  .replace(/through round198/g, "through round249");
