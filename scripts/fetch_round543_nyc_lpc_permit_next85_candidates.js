...
source = source
  .replace(/const ROUND = 505;/g, "const ROUND = 543;")
  .replace(/round505_nyc_lpc_permit_next76/g, "round543_nyc_lpc_permit_next85")
  .replace(/round505/g, "round543")
  .replace(/Round505/g, "Round543")
  .replace(/next76/g, "next85")
  .replace(/Next76/g, "Next85")
  .replace(/through round501/g, "through round539");
...
source = replaceOnce(
  ...
  'latest_lpc_permit_pack: "tmp/subagents/round539_nyc_lpc_permit_next84/candidates.json"'
);
