...
source = source
  .replace(/const ROUND = 351;/g, "const ROUND = 366;")
  .replace(/round351_nyc_lpc_permit_next35/g, "round366_nyc_lpc_permit_next39")
  .replace(/round351/g, "round366")
  .replace(/Round351/g, "Round366")
  .replace(/next35/g, "next39")
  .replace(/Next35/g, "Next39")
  .replace(/through round346/g, "through round363");
