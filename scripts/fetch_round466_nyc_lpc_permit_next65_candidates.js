...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 466;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round466_nyc_lpc_permit_next65")
  .replace(/round405/g, "round466")
  .replace(/Round405/g, "Round466")
  .replace(/next48/g, "next65")
  .replace(/Next48/g, "Next65")
  .replace(/through round399/g, "through round462");
