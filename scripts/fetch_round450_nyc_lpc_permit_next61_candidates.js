...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 450;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round450_nyc_lpc_permit_next61")
  .replace(/round405/g, "round450")
  .replace(/Round405/g, "Round450")
  .replace(/next48/g, "next61")
  .replace(/Next48/g, "Next61")
  .replace(/through round399/g, "through round447");
