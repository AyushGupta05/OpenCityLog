...
source = source
  .replace(/const ROUND = 405;/g, "const ROUND = 446;")
  .replace(/round405_nyc_lpc_permit_next48/g, "round446_nyc_lpc_permit_next59")
  .replace(/round405/g, "round446")
  .replace(/Round405/g, "Round446")
  .replace(/next48/g, "next59")
  .replace(/Next48/g, "Next59")
  .replace(/through round399/g, "through round443");
