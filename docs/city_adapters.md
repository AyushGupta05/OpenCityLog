...
- `config/cities/london.json`: default public atlas city. Generated artifacts combine the London discovery catalog with partial row-level brownfield, LFB incident, TfL disruption, and curated milestone events.
- `config/cities/nyc.json`: first US atlas city. Generated artifacts combine the NYC discovery catalog with partial DOB, DOT, ZAP, permitted-event, 311, collision, and curated milestone events.
