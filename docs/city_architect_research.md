...
A city architect is trying to judge whether a proposed change has a defensible relationship to local context, movement, public realm, inclusion, services, environment, and everyday use. They need:
...
- Gehl's Urban95 Public Life Data Framework emphasizes public-life data as an evidence feedback loop: understand how people use places now, test changes, assess observed conditions, and refine designs. Source: https://www.gehlpeople.com/knowledge-hub/publications/urban95-public-life-data-framework/
- The RIBA/University of Reading Social Value Toolkit for Architecture points toward post-occupancy evaluation and evidence about effects on people and communities, which supports adding fieldwork prompts and evidence gaps instead of unsupported scores. Source: https://research-information.bris.ac.uk/en/publications/social-value-toolkit-for-architecture-guidance-on-evaluating-the-/
