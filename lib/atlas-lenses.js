...
const LENS_DEFINITIONS = [
  ...
  },
  {
    ...
    group: "transport",
    category: "transport",
    primary_object_type: "journey speed or road activity record",
    visual_metaphor: "route and corridor traces",
    color_role: "green to red activity or delay proxy colors",
  ...
  },
  {
    ...
    primary_object_type: "public service record or access-gap evidence cell",
    visual_metaphor: "access gap seams",
    color_role: "civic amber with gap severity strokes",
  ...
  },
  {
    ...
    group: "civic",
    category: "civic_services",
    primary_object_type: "service demand or civic incident record",
    visual_metaphor: "demand pressure grid",
    color_role: "demand pressure bands with confidence cues",
  ...
  },
  {
    ...
    group: "economy",
    category: "economy",
    primary_object_type: "economic anchor, property, employment, or visitor activity record",
    visual_metaphor: "economic pull nodes and flow lines",
    color_role: "economic pull node and flow colors",
  ...
  },
  {
    ...
    group: "utilities",
    category: "utilities",
    primary_object_type: "utility asset, capacity, or network record",
    visual_metaphor: "utility network traces and assets",
    color_role: "utility brown with asset symbols",
  ...
  },
  {
    ...
    group: "utilities",
    category: "utilities",
    primary_object_type: "utility resilience, failure, or risk record",
    visual_metaphor: "network resilience hierarchy",
    color_role: "resilience line styles with risk cues",
